...
bool SyntaxAn::Rat18S() {
	cout << "<Rat18S> -> %% <Opt Declaration List> <Statement List>" << endl;
...
//R30. <Primary> :: = <Identifier> | <Integer> | <Identifier>  (<IDs>) | (<Expression>) | true | false
//R31. <Empty>   :: = e
